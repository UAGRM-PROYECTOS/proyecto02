<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ $orden->name ?? __('Show') . " " . __('entregas') }}
        </h2>
    </x-slot>
                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            ...
                            <p class="mt-2 text-sm text-gray-700">Details of {{ __('entregas') }}.</p>
                        </div>
                    ...
                    <div class="sm:flex sm:items-center">
                        ...
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('orden.pedido', $orden->id) }}"  class="block rounded-md bg-green-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Pedir</a>
                        </div>
                    </div>
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
