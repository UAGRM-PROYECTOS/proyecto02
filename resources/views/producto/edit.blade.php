                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900"><i class="fa-solid fa-pen-to-square"></i></h1>
                            <p class="mt-2 text-sm text-gray-700">Actualizar el {{ __('Producto') }} Existente.</p>
                        </div>
                    ...
                    <div class="md:flex-shrink-0 md:w-1/3 md:pr-8">
                        @if($producto->imagen)
                            <img src="{{ $producto->imagen }}" class="max-w-full h-auto rounded-lg"/>
                        @endif
                    </div>
                    <div class="flow-root">
