...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="bg-green text-black/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-1">
                        <div class="grid gap-1 lg:grid-cols-1 lg:gap-8">
                            <a
                                href="{{ route('login') }}"
                                id="docs-card"
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        src="https://res.cloudinary.com/drjvgyusx/image/upload/v1720578579/logo_jojjjr.jpg"
                                        alt="Abasto Cruz"
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Bienvenido a AbastoCruz</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                            En Abastocruz nos dedicamos a ofrecerte las frutas y verduras más frescas directamente en la puerta de tu casa. 
                                        Haz tu pedido y nosotros nos encargamos de la entrega a domicilio, garantizando la mejor calidad en cada producto.
                                    </p>
                                        </div>
                                    </div>
