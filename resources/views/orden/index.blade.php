										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $orden->fecha }}</td>
                                            ...
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                <form action="{{ route('ordens.destroy', $orden->id) }}" method="POST">
                                                    <a href="{{ route('ordens.show', $orden->id) }}" class="text-gray-600 font-bold hover:text-gray-900 mr-2"><i class="fa-solid fa-eye"></i>{{ __('Ver') }}</a>
                                                    @if($orden->estado_id ==4)
          
          @else
          <a href="{{ route('ordens.edit', $orden->id) }}" class="text-green-600 font-bold hover:text-green-900  mr-2"><i class="fa-solid fa-pen-to-square"></i>{{ __('Editar') }}</a>
          @endif
